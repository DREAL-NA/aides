...
class MecenatController extends Controller
{
    /**
    ...
    public function __invoke()
    {
        ...
        return view('front.aides', compact('countCallsForProjects', 'primary_thematics', 'perimeters', 'callsOfTheWeek', 'project_holders'));
