...
class ExportController extends Controller {
	...
	public function ods() {
		...
		$headerRow = [ 'Sous-thématique', 'Intitulé', 'Date de clôture', 'Porteur du dispositif', 'Périmètre', 'Objectifs', 'Bénéficiaires', 'Dotation', 'Relais technique DREAL / DDTMs', 'Contact(s) porteur de projet', 'Lien vers le site' ];
		...
		if($this->callsForProjects->isEmpty()) {
			...
			foreach($this->callsForProjects as $thematic => $callsForProjects) {
				...
				foreach($callsForProjects as $callsForProject) {
					...
					$styleRow = in_array($callsForProject->id, $callsOfTheWeek->toArray()) ? $styleRow->setBackgroundColor('5CDB95') : $styleRow;
